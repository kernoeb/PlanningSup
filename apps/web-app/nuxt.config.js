...
export default {
  ...
  */
  ...
  publicRuntimeConfig: {
    ...
    defaultPlanning: process.env.DEFAULT_PLANNING_ID || 'iut-de-vannes.butdutinfo.1ereannee.gr1a.gr1a1',
    ...
    i18n: {
      ...
      copySelection: 'Copier la sélection actuelle sous forme d\'URL dans le presse-papier',
      createFavoritesGroup: 'Créer un groupe de favoris',
      copiedToClipboard: 'Copié dans le presse-papier',
      error: 'Une erreur s\'est produite, désolé.',
