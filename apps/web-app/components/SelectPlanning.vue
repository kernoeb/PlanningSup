  ...
  methods: {
    ...
    addFavorite (id) {
      if (!(id in this.favorites)) {
        ...
        this.$cookies.set('favorites', this.favorites, { maxAge: 34560000 })
        this.getNames()
        this.$nextTick(() => {
          this.refreshFavorites()
        })
    ...
    renameFavoriteGroup (favoriteGroup) {
      ...
      this.$cookies.set('group-favorites', this.groupFavorites, { maxAge: 34560000 })
      this.newFavoriteName = ''
    ...
    createFavoriteGroup () {
      ...
      this.$cookies.set('group-favorites', newGroupFavoriteList, { maxAge: 34560000 })
      this.newFavoriteGroupName = ''
      this.refreshFavorites()
        ...
        try {
          ...
          if (typeof favorites === 'string') {
            ...
            if (oldFavorites.length) {
              ...
              this.$cookies.set('favorites', favorites, { maxAge: 34560000 })
            }
          }
